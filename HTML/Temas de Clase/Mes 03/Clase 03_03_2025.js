...
// 1. Filtrado
    ...
    */
    ...
    let arrayFiltered = arrayObjects.filter(arrayObjects => arrayObjects.id <= 4);
    ...
    */
    ...
    let arrayMovies = ["The Matrix", "The Lord of the Rings", "The Godfather", "The Dark Knight", "The Shawshank Redemption", "Forrest Gump", "The Silence of the Lambs", "American Pie", "Amercian Psycho", "Avatar"];
    
    // Una forma de hacerlo
    let arrayMoviesFiltered1 = arrayMovies.filter(arrayMovies => arrayMovies.startsWith("A"));
    // Otra froma de hacerlo
    let arrayMoviesFiltered2 = arrayMovies.filter(arrayMovies => arrayMovies[0] == "A");
   ...
   let arrayPeliculas = [
        ...
        {name: 'The Shawshank Redemption', size: 'The Shawshank Redemption'.length},
        {name: 'Forrest Gump', size: 'Forrest Gump'.length},
        {name: 'The Silence of the Lambs', size: 'The Silence of the Lambs'.length},
    ];

    let sumSizesArray = arrayPeliculas.reduce((sum, current) => sum + current.size, 0);
...
function arrayList(array) {
    ...
    for (let i = 0; i < array.length; i++) {
        console.log(`   <li>Name: ${array[i].name} | Size: ${array[i].size}</li><br>`);
    }
    console.log(`</lo>`);
}
